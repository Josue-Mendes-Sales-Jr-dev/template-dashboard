...
export const Layout=(props:ILayoutProps)=>{
    return(
        <>
        <div className=" w-screen h-[100vh] flex sm:flex-row flex-col gap-2 overflow-auto scrollbar-thin ">
            <Navbar className="hidden sm:flex"/>
            <div className="flex sm:w-[95%] h-[90%] lg:h-[96vh] items-center gap-5 flex-col border-box">
                <Header className='w-[100%] sm:w-[90%] lg:w-[97%] h-[10%] sm:h-[15%] lg:h-[10%]  sm:rounded-br-lg sm:rounded-bl-lg'/>
