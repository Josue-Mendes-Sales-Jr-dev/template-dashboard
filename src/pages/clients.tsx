  ...
  <>
     <Layout>
      <div className='w-[100%] h-[100%] mt-2 flex flex-col pb-2 items-center justify-center'>
        <ul className=' flex  items-center justify-between lg:justify-center w-[95%]  py-2 px-[1rem] bg-gray-900 text-white h-[60px] rounded-tl-lg rounded-tr-lg'>
        ...
        <div className='flex flex-col gap-3 w-[95%] items-center h-[75vh] sm:h-[60vh] lg:h-[80vh] pb-2 rounded-bl-lg rounded-br-lg bg-gray-900 overflow-hidden'>
                    ...
                    <li  className=' flex items-center justify-between lg:justify-center  w-[98%] px-3 bg-gray-300 h-[55px] rounded'>
                        <li key={items.id} className='lg:w-[25%] w-[20%] py-2' >
                           <div className='flex w-[100%] gap-3 lg:gap-5 items-center'>
                            <span className='flex items-center justify-center rounded bg-red-700 w-[35px] h-[35px]'><IoMdPerson className='sm:w-[30px] w-[25px]'/></span>
